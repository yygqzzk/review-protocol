...
func (c *operationClient) AuditReview(ctx context.Context, in *AuditReviewReq, opts ...grpc.CallOption) (*AuditReviewRsp, error) {
...
func (c *operationClient) AuditAppeal(ctx context.Context, in *AuditAppealReq, opts ...grpc.CallOption) (*AuditAppealRsp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedOperationServer) AuditReview(context.Context, *AuditReviewReq) (*AuditReviewRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuditReview not implemented")
}
func (UnimplementedOperationServer) AuditAppeal(context.Context, *AuditAppealReq) (*AuditAppealRsp, error) {
...
func _Operation_AuditReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperationServer).AuditReview(ctx, req.(*AuditReviewReq))
	}
...
func _Operation_AuditAppeal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperationServer).AuditAppeal(ctx, req.(*AuditAppealReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Operation_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "operation/v1/opertation.proto",
}
